...
!      
     ...
     +                           COAL_MODEL_GENE_TRANS_FILE,'ZD')  ! 374
...
!
         ...
         DO
            ...
            DO
               ...
               IF(LINKED_CLASS < 0 .OR. CLASS_POINTER > 1024) THEN 
                 EXIT
               ENDIF
            ...
            IF(VECTOR_POINTER > AVAIL_DATA_YEARS) THEN 
              EXIT
            ENDIF
            IF(VECTOR_POINTER == 1) THEN 
              CYCLE
            ENDIF
            IF(VECTOR_ASSET_CLASSES(VECTOR_POINTER) == 0. .OR. 
     +                                        CLASS_POINTER > 1024) THEN 
              EXIT
            ENDIF
         ENDDO
...
!     +                           + R_INCOME_VARS(:,monthly_oth_taxes)
     ...
     +                   - R_INCOME_VARS(:,IPL_Total_Operating_Expenses)
      RETURN
!***********************************************************************
      ENTRY MTHLY_TTM_REVENUE_REPORT()
!***********************************************************************
!
...
!
     ...
     +                               //',,,,,,,,,,,,,,,,,,,,,,,,,,,,,'
                  ...
                  YR = RPT_YR - BASE_YEAR
                  IF(YR < 0 .OR. YR > 1 .OR. MO < 1) THEN 
                    CYCLE   ! Data for the base year or the first year
                  ENDIF
                  READ(RECLN,*,IOSTAT=IOS) DELETE,RPT_MO,RPT_YR,ACTIVE,
     +                                  RESERVED,
     +                                  RESERVED,
