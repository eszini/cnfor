...
C
     ...
     +                                            SUBSIDARY_VARIABLES)
                  ...
                  ENDIF
               ENDIF
               IF(CLASS > 0 .AND. MASTER_CLASS_LIST(CLASS) == 0) THEN 
                 CYCLE
               ENDIF
...
C                       COMMON_SHARES(2,CLASS_POS) = .00001
     ...
     +                               BOOK_VALUE_STOCK(2,CLASS_POS)) THEN 
                       EXIT
                     ENDIF
                  ENDDO
               ENDIF
      ...
      DO LINKS_2_PARENT = 1, SUBS_LINKED_2_PARENT+1
         ...
         IF(SBU_LINKED_LIST(ID_NUM,0) > 0) THEN
            ...
            DO J = 1, MAX_LINKED_CLASSES 
               IF(SBU_LINKED_LIST(ID_NUM,J) < 0) THEN 
                 EXIT
               ENDIF
