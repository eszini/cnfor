...
!     FINASSET MODULE 5/7/85
!  NOTE:  ADDITITONS FOR MIDAS GOLD COPYRIGTH (c) 1991
!         M.S. GERBER & ASSOCIATES, INC.  ALL RIGHTS RESERVED
!  DATE      ADDITION OR CHANGE
!  MANY      DO LOOPS CHANGED FROM DO 10... TO DO WITH AN ENDDO STATEMENT
!  5/25/91   CAPITIALIZED INTEREST RATE
!  6/ 4/91   ACE DEPRECIATION FOR EA AND FUTURE ASSETS
!  4/13/92   REAL PROPERTY VALUE ADDED FOR PROP TAX CALCULATIONS
!  2/3/93    CURRENT INTEREST VECTOR
!  2/7/93    MADE THE MODULE SIZECOM.MON DEPENDENT
!***********************************************************************
!
!          SUBROUTINE TO CALCULATE FUTURE ASSET VALUE
!          COPYRIGHT (C) 1983-1993  M.S. GERBER & ASSOCIATES, INC.
!          ALL RIGHTS RESERVED
!***********************************************************************
!
...
!     DECLARATION FOR WORLD VARIABLES FOR FUTURE ASSETS
      ...
      INTEGER (kind=2) ::  BASEYEAR,MAX_YEARS
